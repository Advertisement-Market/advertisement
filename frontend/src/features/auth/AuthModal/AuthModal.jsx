...
function OrDivider({ label = 'or continue with email' }) {
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '16px 0' }}>
      <span style={line} />
      <span
        style={{ fontSize: 12, color: 'var(--ink-soft)', fontWeight: 400, whiteSpace: 'nowrap' }}
      >
        {label}
      </span>
      <span style={line} />
    ...
    <>
      ...
      >
        ...
        >
          ...
          <a
            href="#"
            style={{ fontSize: 13, color: 'var(--gold-dim)' }}
      ...
      >
        ...
        <div className="form-group">
          ...
          <div style={{ display: 'flex', gap: 8 }}>
            <select
              ...
              className="form-control"
              defaultValue="+91"
              style={{ flex: '0 0 104px', paddingRight: 30 }}
            >
        ...
        <div style={{ marginBottom: 14 }}>
          ...
          >
            ...
            />{' '}
            I agree to the{' '}
            <a href="#" style={{ color: 'var(--gold-dim)' }} onClick={(e) => e.preventDefault()}>
