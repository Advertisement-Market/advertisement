...
CREATE TABLE advertiser_profiles (
    ...
    CONSTRAINT fk_advertiser_profiles_address FOREIGN KEY (address_id) REFERENCES addresses (id) ON DELETE CASCADE
);
...
CREATE TABLE owner_profiles (
    ...
    CONSTRAINT fk_owner_profiles_address FOREIGN KEY (address_id) REFERENCES addresses (id) ON DELETE CASCADE
);
...
CREATE TABLE billboard_listings (
    ...
    CONSTRAINT fk_billboard_listings_address FOREIGN KEY (address_id) REFERENCES addresses (id) ON DELETE CASCADE
);
...
CREATE TABLE agency_profiles (
    ...
    CONSTRAINT fk_agency_profiles_address FOREIGN KEY (address_id) REFERENCES addresses (id) ON DELETE CASCADE
);
